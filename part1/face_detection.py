"""
part1/face_detection.py
-------------------------
Step 3: Face Detection Module (Part 1)
...
MODEL_PATH = _ROOT / "part1" / "models" / "face_detection_yunet.onnx"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: py part1/face_detection.py <path_to_image>")
        sys.exit(1)
