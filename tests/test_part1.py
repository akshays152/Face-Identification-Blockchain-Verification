...
from part1.face_detection import FaceDetector, detect_face
from part1.face_embedding import FaceEmbedder, get_face_embedding
from part1.face_matching import FaceMatcher, cosine_similarity
from part1.web_search import WebSearcher
from part1.post_extractor import PostExtractor

SAMPLE_FACE = _ROOT / "data" / "sample_face.jpg"


class TestPart1FaceDetection:
...
class TestPart1WebSearchAndExtraction:
