"""
person1/face_embedding.py
-------------------------
Step 3: Face Embedding Module (Person 1)
...
SFACE_MODEL_PATH = _ROOT / "person1" / "models" / "face_recognition_sface.onnx"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: py person1/face_embedding.py <path_to_image>")
        sys.exit(1)
