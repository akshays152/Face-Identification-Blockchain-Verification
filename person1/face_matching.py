"""
person1/face_matching.py
------------------------
Step 6 & Step 7: Face Matching & Handoff Generation (Person 1)
...
and generates the final handoff file: person1/post_result.json.
"""
...
class FaceMatcher:
    ...
    def create_handoff_file(
        ...
        similarity: float,
        output_path: Path = _ROOT / "person1" / "post_result.json",
...
def run_matching_pipeline(
    ...
    candidates: List[Dict[str, Any]],
    output_json: Path = _ROOT / "person1" / "post_result.json",
) -> Dict[str, Any]:
    """
    Executes Person 1 pipeline matching step:
